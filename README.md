...
В нашому проекті в файлі package.json додаємо npm-скрипти для автоматичного деплою
...
Далі обираємо назву сайту. Це має бути унікальний рядок. Рекомендується до проекту 
